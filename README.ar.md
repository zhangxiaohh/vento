...
- [x] 支持国际化的[站点地图](https://docs.astro.build/en/guides/integrations-guide/sitemap/)
- [x] 支持国际化的 [OG 图片](https://www.freecodecamp.org/news/what-is-open-graph-and-how-can-i-use-it-for-my-website/)生成
  - 注意：[satori](https://www.npmjs.com/package/satori) 不支持 RTL 语言，因此 RTL 语言的图片会有一些问题
- [x] 支持国际化的 [RSS 订阅](https://docs.astro.build/en/guides/rss/)
- [ ] 📋 **计划中**
  - [ ] 路由翻译
...
`SITE.title` 配置已被 `site.title` 翻译替换，现在整个站点都使用它。

`SITE.desc` 配置已被 `site.desc` 翻译替换，现在整个站点都使用它。
