...
import './_astro_content-CUxjeKYT.js';
import satori from 'satori';
import { t as translateFor, a as SITE } from './config-CoUBcFaH.js';
...
async function loadGoogleFonts(text, fontName) {
  const fontsConfig = [
    {
...
const postOgImage = async (post, localeKey, localeConfig) => {
...
const siteOgImage = async (localKey, localeConfig) => {
...
async function generateOgImageForPost(post, localeKey, localeConfig) {
  const svg = await postOgImage(post, localeKey, localeConfig);
  return svgBufferToPngBuffer(svg);
}
async function generateOgImageForSite(localKey, localeConfig) {
