import { A as AstroError, L as LiveContentConfigError, B as AstroUserError, o as objectType, z as dateType, n as arrayType, l as stringType, U as UnknownContentCollectionError, R as RenderUndefinedEntryError, a as createComponent, C as unescapeHTML, b as renderTemplate, D as escape, E as renderUniqueStylesheet, G as renderScriptElement, H as createHeadAndContent, r as renderComponent } from './astro/server-DNwJ7Yw1.js';
import { r as removeBase, e as isRemotePath, p as prependForwardSlash } from './config-CoUBcFaH.js';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content-DxMSALuC.js');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/vento/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://zhangxiaohh.github.io", "SSR": true};
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    if (collection in contentCollectionToEntryMap) {
      ...
      const { default: imageAssetMap } = await import('./content-assets-A7YMxwRy.js');
      const result = [];
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets-C7PjTQe_.js').then(n => n._);
...
export { CONTENT_LAYER_TYPE as C, DEFAULT_OUTPUT_FORMAT as D, LIVE_CONTENT_TYPE as L, VALID_SUPPORTED_FORMATS as V, getCollection as a, DEFAULT_HASH_PROPS as b, defineCollection as d, getEntry as g, pLimit as p, renderEntry as r };
