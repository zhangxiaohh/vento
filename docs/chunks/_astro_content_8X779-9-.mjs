import { A as AstroError, L as LiveContentConfigError, B as AstroUserError, o as objectType, z as dateType, n as arrayType, l as stringType, U as UnknownContentCollectionError, R as RenderUndefinedEntryError, a as createComponent, C as unescapeHTML, b as renderTemplate, D as escape, E as renderUniqueStylesheet, G as renderScriptElement, H as createHeadAndContent, r as renderComponent } from './astro/server_DNwJ7Yw1.mjs';
import { r as removeBase, e as isRemotePath, p as prependForwardSlash } from './config_eYlZWC1t.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_c0Tjczop.mjs');
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    if (collection in contentCollectionToEntryMap) {
      ...
      const { default: imageAssetMap } = await import('./content-assets_lx7SuiMn.mjs');
      const result = [];
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_B6CXkdj-.mjs').then(n => n._);
